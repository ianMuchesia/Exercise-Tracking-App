...
<h1 class="update-header">Update Page</h1>
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" class="update-workout">
        <div class="exercise-container">
            <label for="exercise">Exercise Title</label>
            <input type="text" class="input-workout <?php echo $titleErr?"input-error":""; ?>"
            name="title"
        ...
        <div class="load-container">
            ...
            <input type="number" name="load" id="load" class="input-workout <?php echo $loadLiftedErr?" input-error":null; ?>"
            value="<?php echo $loadLifted;?>">
            <p class="error-message"><?php echo $loadLiftedErr;?></p>
        </div>
        <div class="reps-container">
            <label for="reps">Reps Taken</label>
            <input type="number" name="reps" id="reps"  class="input-workout <?php echo $repsErr?" input-error":null; ?>"
            value="<?php echo $reps;?>">
